...
public class DoctorController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<DoctorResponseDTO> getDoctorById(@PathVariable Integer id) {
    ...
    public ResponseEntity<DoctorResponseDTO> getDoctorByUserId(@PathVariable Integer userId) {
    ...
    public ResponseEntity<DoctorWithUserResponseDTO> createDoctorWithUser(
        ...
        DoctorWithUserResponseDTO created = doctorService.createDoctorWithUser(request);
        return ResponseEntity.ok(created);
    }
